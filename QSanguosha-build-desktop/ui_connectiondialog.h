...
public:
    ...
    void retranslateUi(QDialog *ConnectionDialog)
    {
        ...
        portLabel->setText(QApplication::translate("ConnectionDialog", "Port", 0, QApplication::UnicodeUTF8));
